...
export default function Form({ setUser, setAuthState }) {
  ...
  {user && (<>
    <h1 className="text-5xl font-semibold">Welcome {user.displayName} </h1>
        <a
href='/'
    className="m-8 active:scale-[.98] active:duration-75 transition-all hover:scale-[1.01]  ease-in-out transform py-4 bg-violet-500 rounded-xl text-white font-bold text-lg">
     Home
    </a>
  </>)}
  ...
  {!user &&(<>        <div className=" w-11/12 max-w-[700px] px-10 py-20 rounded-3xl bg-white border-2 border-gray-100">
